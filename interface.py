...
class ChatbotApp(ctk.CTk):
    def __init__(self):
        ...
        # Créer une instance de StringVar avec la valeur par défaut souhaitée
        ...
        self.scaling_optionemenu = ctk.CTkOptionMenu(
            ...
            variable=default_scaling_value  # Définir la valeur par défaut ici
        )
        ...
        self.file_import_button = ctk.CTkButton(self, text="Importer fichier", command=self.import_file)
        self.file_import_button.grid(row=2, column=1, padx=(20, 0), pady=(10, 10), sticky="ew")
    ...
    def get_bot_response(self, message):
        # Fonction basique pour les réponses du chatbot
    ...
    def import_file(self):
        # Ouvrir une boîte de dialogue pour importer un fichier
        file_path = filedialog.askopenfilename(title="Sélectionner un fichier")
        if file_path:
            # Afficher le chemin du fichier sélectionné dans la zone de chat
